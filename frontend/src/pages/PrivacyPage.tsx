    ...
    <article className="prose prose-sm prose-gray max-w-none">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-600">
          ...
          <li>
            <strong>Usage Data:</strong> Information about how you interact with our website, such as your IP address,
          ...
          <li>
            ...
            our site. Cookies help us understand how you use our website and allow us to personalize content and
            advertisements.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-600">
          ...
          <li>
            <strong>Communication:</strong> To send you updates, newsletters, or respond to your inquiries.
          </li>
          <li>
            <strong>Personalization:</strong> To tailor the job listings and content we present to you based on your
            preferences and usage patterns.
          </li>
          <li>
            <strong>Improvement of Services:</strong> To analyze and improve the performance and usability of our
            website.
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-600">
          ...
          <li>
            <strong>Service Providers:</strong> We may engage third-party service providers to assist with website
            functionality, data analysis, or other services to help operate and improve HiringEspresso.
          </li>
          <li>
